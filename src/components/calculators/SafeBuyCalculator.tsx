...
const isOverSafeLimit = itemPrice > safeLimit;
    ...
    if (newRunway < 1.5 || itemPrice > currentReserves) {
      ...
      advice = `Tohle ti vymaže ${runwayLoss.toFixed(1)} měsíce klidného spaní. Radši počkej, až víc vyděláš.`;
    }
  ...
  return (
    <div className="fade-in app-container">
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }}>
        <h2 style={{ fontSize: 'clamp(1.5rem, 6vw, 2.4rem)', fontWeight: '900', marginBottom: '15px' }}>
          Můžu si to dovolit? <span style={{ color: simulation.color }}>{simulation.status}</span>
        </h2>
        <p style={{ fontSize: '1.1rem', opacity: 0.8, maxWidth: '750px', margin: '0 auto', lineHeight: '1.6' }}>
