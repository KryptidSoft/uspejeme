...
export const ProsperityPlanner: React.FC = () => {
  ...
  const handleSave = () => {
    ...
    updateData({
	  ...
	  taxMode: data.taxMode as 'pausal_dan' | 'vydaje_60' | 'skutecne_vydaje'
    });
    setSaved(true);
  ...
  return (
    <div className="fade-in app-container">
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }}>
        <h1 style={{ color: 'white', fontSize: 'clamp(1.8rem, 6vw, 2.5rem)', marginBottom: '15px', fontWeight: '800' }}>Plánovač finanční prosperity</h1>
            ...
            <div className="smart-grid" style={{ gap: '20px' }}>
              ...
              <section>
                ...
                >
                  ...
                  <option value="skutecne_vydaje">Vlastní odhad % zdanění</option>
                </select>
